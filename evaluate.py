...
parser.add_argument('--data_dir', default='data/task1/',
                    help="Directory containing the dataset")
parser.add_argument('--bert_model_dir', default='bert-base-uncased',
...
def evaluate(model, data_iterator, params, mark='Eval', verbose=False):
    ...
    for _ in range(params.eval_steps):
        ...
        loss = model(batch_data, token_type_ids=None,
        ...
        batch_output = model(batch_data, token_type_ids=None,
        ...
        true_tags.extend([idx2tag.get(idx)
                          for indices in batch_tags for idx in indices])
